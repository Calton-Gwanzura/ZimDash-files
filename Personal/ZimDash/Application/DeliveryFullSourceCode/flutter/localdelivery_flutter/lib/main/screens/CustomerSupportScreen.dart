                ...
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Container(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text('${language.supportType} : ',
                                        style: primaryTextStyle()),
                                    Text(item.supportType.validate(),
                                        style: primaryTextStyle()),
                                  ],
                                ),
                                8.height,
                                ...
                                if (item.resolutionDetail != null)
                                  Row(
                                    children: [
                                      Text('${language.resolutionDetails} :',
                                          style: primaryTextStyle()),
                                      10.width,
                                      Text(item.resolutionDetail.validate(),
                                          style: primaryTextStyle()),
                                    ],
                                  ),
                              ],
                        ...
                        ChatWithAdminScreen(
                                item.supportChatHistory, item.supportId)
                            .launch(context);
                      });
                    },
                  )
