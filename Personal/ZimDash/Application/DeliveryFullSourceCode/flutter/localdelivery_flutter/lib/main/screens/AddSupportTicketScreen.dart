                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      20.width,
                      Container(height: 38, decoration: boxDecorationWithRoundedCorners(border: Border.all(color: Colors.grey.withOpacity(0.2)), backgroundColor: Colors.transparent), child: Text(language.video, style: boldTextStyle(size: 12)).paddingAll(6).center()).onTap(() async {
                        video = null;
                  ...
                  if (image != null && !image!.path.isEmptyOrNull)
                    Container(
                      decoration: boxDecorationWithRoundedCorners(border: Border.all(color: ColorUtils.colorPrimary), backgroundColor: Colors.transparent),
                      child: Image.file(File(image!.path), height: 150, width: MediaQuery.of(context).size.width, fit: BoxFit.cover, alignment: Alignment.center).cornerRadiusWithClipRRect(10).center(),
                    ),
